...
# def generate_frames():
#     global running, prev_frame, last_capture_time
...
#                     # 🎯 FILTER LOGIC
#                     filtered_objects = [obj for obj in objects if obj in TARGET_OBJECTS]

#                     if filtered_objects:
#                         print("Detected:", filtered_objects)

#                         filename = f"backend/captures/{int(current_time)}.jpg"
